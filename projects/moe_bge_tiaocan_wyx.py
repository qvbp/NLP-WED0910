...
def optuna_hyperparameter_optimization():
    ...
    base_config = {
        ...
        'patience': 5,
        # 请修改为你的实际数据路径
        'data_path': '/mnt/cfs/huangzhiwei/NLP-WED0910/datas/train_new_wyx.json',
        'val_data_path': '/mnt/cfs/huangzhiwei/NLP-WED0910/datas/val.json',
        'checkpoint_dir': 'optuna_checkpoints_update0527_wyx',
        'device': device,
        'weight_decay': 0.01
    }
    
    # 创建结果保存目录
    results_dir = 'hyperparameter_results_0527moe_wyx'
    os.makedirs(results_dir, exist_ok=True)
...
if __name__ == '__main__':
    ...
    # 检查数据路径
    data_paths = [
        '/mnt/cfs/huangzhiwei/NLP-WED0910/datas/train_new_wyx.json',
